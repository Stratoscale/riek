...
export default class RIEBase extends React.Component {
  ...
  makeClassString = () => {
    ...
    if (this.editing && this.props.classEditing) classNames.push(this.props.classEditing);
    if (this.loading && this.props.classLoading) classNames.push(this.props.classLoading);
    if (this.disabled && this.props.classDisabled) classNames.push(this.props.classDisabled);
